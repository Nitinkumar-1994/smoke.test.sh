...
function check_network() (
    ...
    function check_nscd_and_sssd() {
        ...
        if $nscd_running && $sssd_running; then
            ...
            # If youâ€™re running Red Hat SSSD, youâ€™ll need to modify the nscd configuration;
            # with SSSD enabled, donâ€™t use nscd to cache passwd, group, or netgroup information.
